...
/**
 * Copy of HibernateValidator implementation
 *
 * @see https://github.com/hibernate/hibernate-validator/blob/caff03a58ce8c538c3da4fe24eab2961146e6d51/engine/src/main/java/org/hibernate/validator/internal/util/DomainNameUtil.java
 */
public final class DomainNameUtil {
    ...
    private static final Pattern DOMAIN_PATTERN = Pattern
            .compile(DOMAIN + "|\\[" + IP_V6_DOMAIN + "\\]", CASE_INSENSITIVE);
