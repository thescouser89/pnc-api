...
/**
 * Spec: https://slsa.dev/spec/v1.1/provenance#buildmetadata
 */
public class Metadata {

    /**
     * Identifies this particular build invocation, which can be useful for finding associated logs or other ad-hoc
     * analysis. The exact meaning and format is defined by builder.id; by default it is treated as opaque and
