...
public enum BuildType {
    ...
    /**
     * Build wrapperRpms using modified pom file, rpm maven plugin and PME for alignment. The artifacts are published
     * as maven artifacts to {@link RepositoryType#MAVEN} repository.
     */
